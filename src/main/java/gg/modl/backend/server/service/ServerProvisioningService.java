...
public class ServerProvisioningService {
    ...
    private void seedAIModerationSettings(MongoTemplate template) {
        ...
        chatAbuseConfig.put("aiDescription", "Chat abuse is the act of spamming, excessive profanity, abusive language, inappropriate topics or jokes, and misleading information");
        ...
        antiSocialConfig.put("aiDescription", "Anti social is the act of harassing, threatening, black-mailing, or otherwise abusing another player or group of players. This includes bigotry and other forms of discrimination against protected classes.");
    ...
    private Map<String, Object> buildApplicationForm() {
        ...
        fields.add(formField("1753244525756", "text", "What languages can you speak?", "If you speak more than one, please list your level of fluency in each.", true, 4, "1753244011186"));
        fields.add(formField("1753244114967", "checkbox", "Do you have access to both a working microphone and recording software?", null, true, 5, "1753244011186"));
        ...
        fields.add(formField("1753244506417", "textarea", "Have you ever been banned or muted on this server? If yes, what have you learned moving forward?", "If so, please explain each occurrence.", true, 0, "1753244183109"));
        fields.add(formField("1753244551193", "textarea", "Describe your moderation background and previous experience.", "The more detail the better. This doesn't have to be limited to Minecraft servers, as we welcome any previous experience in moderating Discord servers or even other game communities.  Please provide references and proof for your more notable experiences.", true, 1, "1753244183109"));
        fields.add(formField("1753244585381", "textarea", "Why do you want to become a moderator on this server?", "Again, the more detail on this question the better. Providing us with as much detail as possible will help us understand your motivation and will to become a moderator!", true, 9, "1753244183109"));
        ...
        fields.add(formField("1753244687326", "textarea", "You are a Moderator with the ability to mute and ban. You are playing on the server with a friend and come across a player who you think is hacking. They kill your friend, but then you kill them. What do you do in this situation?", null, true, 11, "1753244183109"));
        fields.add(formField("1753244762984", "textarea", "You are a Moderator with the ability to mute and ban. You are spectating a player who you believe is hacking, but multiple chat reports come in about a player in another gamemode who is being violently disruptive in chat. Somehow, you are the only moderator online. How do you handle the two situations?", null, true, 12, "1753244183109"));
        fields.add(formField("1753244861431", "textarea", "You are a Moderator with the ability to mute and ban. You see 5+ reports come in accusing the same player of breaking the chat rules. You join the server where the situation is taking place and open the accused player's recent chat history. You see that they were being rude, but haven't actually broken a rule. When you decide that they are not guilty, the same group reports the player again, and sends you multiple private messages calling you a bad moderator for not muting the player. What's the first step in dealing with this situation? Explain how this step will move towards resolving the conflict.", null, true, 13, "1753244183109"));
        fields.add(formField("1753244931272", "textarea", "You are the newest Moderator on the team. While you are spectating a game, you witness a Sr. Moderator mining suspiciously. In a matter of minutes, you get enough evidence that suggests that the Sr. Moderator may likely be x-raying. Suddenly, they head to the surface and do nothing suspicious for the rest of your time spectating them. How do you proceed?", null, true, 14, "1753244183109"));
        fields.add(formField("1753245023983", "textarea", "You are a Moderator with the ability to mute and ban. You notice a well-known streamer/YouTuber closely affiliated with the server is nicked. They message a player words encouraging suicide under their disguised alias. What steps do you take to resolve the situation?", null, true, 15, "1753244183109"));
        ...
        fields.add(formField("1753245137086", "textarea", "Please provide proof of previous work in link form here (Imgur, YouTube, etc)", null, true, 17, "1753244277605"));
        ...
        fields.add(formField("1753245348514", "text", "Have you ever been banned or muted on this server? If yes, what have you learned moving forward?", "If so, please explain each occurrence.", true, 23, "1753244286527"));
        fields.add(formField("1753245358313", "text", "A link to your YouTube and/or Stream Channel", null, true, 24, "1753244286527"));
        fields.add(formField("1753245471763", "checkbox", "We will email the contact email listed on the channel for proof of ownership, please verify it is accurate and actively monitored.", null, true, 25, "1753244286527"));
    ...
    private void seedQuickResponses(MongoTemplate template) {
        ...
        categories.add(quickResponseCategory("chat_report_actions", "Chat Report Actions", List.of("chat_report"), 1, List.of(
                quickResponseAction("accept_report", "Accept Report", "Thank you for creating this report. After careful review, we have accepted this and the reported player will be receiving a punishment.", 1, true, true, null),
                quickResponseAction("reject_insufficient_chat", "More Evidence", "Thank you for submitting this chat report. After reviewing the evidence provided, we need additional evidence to proceed with action.", 2, false, false, null),
                quickResponseAction("reject_no_violation_chat", "Reject - No Violation", "Thank you for submitting this chat report. After reviewing the evidence provided, we have determined that this does not violate our community guidelines.", 3, true, false, null)
        )));
        ...
        categories.add(quickResponseCategory("player_report_actions", "Player Report Actions", List.of("player_report"), 2, List.of(
                quickResponseAction("accept_report", "Accept Report", "Thank you for creating this report. After careful review, we have accepted this and the reported player will be receiving a punishment.", 1, true, true, null),
                quickResponseAction("reject_insufficient_player", "More Evidence", "Thank you for submitting this player report. After reviewing the evidence provided, we need additional evidence to proceed with action.", 2, false, false, null),
                quickResponseAction("reject_no_violation_player", "Reject - No Violation", "Thank you for submitting this player report. After reviewing the evidence provided, we have determined that this does not violate our community guidelines.", 3, true, false, null)
        )));

        // Appeal Actions
        categories.add(quickResponseCategory("appeal_actions", "Appeal Actions", List.of("appeal"), 3, List.of(
                quickResponseAction("pardon_full", "Pardon - Full", "After reviewing your appeal, we have decided to remove the punishment completely. We apologize for any inconvenience.", 1, true, false, "pardon"),
                quickResponseAction("reduce_punishment", "Reduce Punishment", "We have reviewed your appeal and decided to reduce the duration of your punishment. Please check your punishment details for the updated duration.", 2, true, false, "reduce"),
                quickResponseAction("reject_upheld", "Reject - Upheld", "After careful consideration of your appeal, we have decided to uphold the original punishment.", 3, true, false, "reject"),
                quickResponseAction("need_more_info_appeal", "Need More Information", "We need additional information to process your appeal. Please provide more details about your situation.", 4, false, false, null)
        )));
        ...
        categories.add(quickResponseCategory("application_actions", "Staff Application Actions", List.of("application"), 4, List.of(
                quickResponseAction("accept_builder", "Accept - Builder", "Congratulations! Your Builder application has been accepted. Welcome to the Builder team! You will receive further instructions and permissions shortly.", 1, true, false, null),
                quickResponseAction("accept_helper", "Accept - Helper", "Congratulations! Your Helper application has been accepted. Welcome to the Helper team! You will receive further instructions and permissions shortly.", 2, true, false, null),
                quickResponseAction("accept_developer", "Accept - Developer", "Congratulations! Your Developer application has been accepted. Welcome to the Developer team! You will receive further instructions and permissions shortly.", 3, true, false, null),
                quickResponseAction("reject_application", "Reject Application", "Thank you for your interest in joining our team. Unfortunately, we have decided not to move forward with your application at this time. You may reapply in the future.", 4, true, false, null),
                quickResponseAction("pending_review", "Pending Review", "Thank you for your application. We are currently reviewing it and will get back to you soon.", 5, false, false, null),
                quickResponseAction("interview_scheduled", "Interview Scheduled", "Your application has progressed to the interview stage. Please check your email for interview details.", 6, false, false, null),
                quickResponseAction("need_more_info_app", "Need More Information", "We need additional information about your application. Please provide more details about your experience and qualifications.", 7, false, false, null)
        )));

        // Bug Report Actions
        categories.add(quickResponseCategory("bug_actions", "Bug Report Actions", List.of("bug"), 5, List.of(
                quickResponseAction("completed", "Fixed", "Thank you for reporting this bug. We have fixed the issue and it will be included in our next update.", 1, true, false, null),
                quickResponseAction("investigating", "Investigating", "Thank you for this bug report. We are currently investigating the issue and will provide updates as they become available.", 2, false, false, null),
                quickResponseAction("need_more_info", "Need More Info", "Thank you for this bug report. We need additional information to investigate this issue. Please provide more details about how to reproduce this bug.", 3, false, false, null),
                quickResponseAction("duplicate", "Duplicate", "This bug has been identified as a duplicate of an existing issue. We appreciate your report and are working on a fix.", 4, true, false, null),
                quickResponseAction("cannot_reproduce", "Cannot Reproduce", "We were unable to reproduce this issue. If you continue to experience this problem, please provide additional details.", 5, true, false, null)
        )));

        // Support Actions
        categories.add(quickResponseCategory("support_actions", "Support Actions", List.of("support"), 6, List.of(
                quickResponseAction("resolved", "Resolved", "Your support request has been resolved. If you need further assistance, please feel free to create a new ticket.", 1, true, false, null),
                quickResponseAction("escalated", "Escalated", "Your support request has been escalated to our specialized team. They will contact you with additional information.", 2, false, false, null),
                quickResponseAction("need_info_support", "Need More Info", "We need additional information to assist you with your request. Please provide more details about your issue.", 3, false, false, null)
        )));

        // General Actions
        categories.add(quickResponseCategory("general_actions", "General Actions", List.of("player_report", "chat_report", "bug", "appeal", "support", "application"), 7, List.of(
                quickResponseAction("acknowledge", "Acknowledge", "Thank you for your message. We have received your ticket and will review it shortly.", 1, false, false, null),
                quickResponseAction("follow_up", "Follow Up", "We are following up on your ticket. Please let us know if you have any additional information or questions.", 2, false, false, null)
        )));
