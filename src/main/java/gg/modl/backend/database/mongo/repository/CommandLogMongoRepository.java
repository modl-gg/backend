...
public class CommandLogMongoRepository extends AbstractServerMongoRepository<CommandLogDocument> {
    public CommandLogMongoRepository(TenantMongoAccess tenantMongoAccess, MongoEntityDiffService diffService) {
        super(CommandLogDocument.class, CollectionName.COMMAND_LOGS, diffService, tenantMongoAccess);
    }
}