...
public record AddEvidenceRequest(
    @Nullable @Size(max = RequestValidationLimits.EVIDENCE_TEXT_MAX_LENGTH) String text,
    ...
    @Nullable @Size(max = RequestValidationLimits.EVIDENCE_URL_MAX_LENGTH) String url,
